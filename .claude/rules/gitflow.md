...
1. **Identifier le ticket** dans `tickets.md` et sur GitHub (issue correspondante)
...
6. **Mettre à jour la date de fin** du ticket dans `tickets.md` et fermer l'issue GitHub
...
- Mettre à jour `tickets.md` avec la date de fin une fois le ticket terminé
